...
def identifyBackground(frame):
    ...
    return top, bottom, left, right, gray_blur, white_key_borders, black_key_borders
...
def findNotes(frame,kernel,kernel_keys, bottom, top,bg, white_key_borders):
    ...
    fgmask = cv2.inRange(fgmask,70,180) #50 is toooo low!
    fgmask = cv2.morphologyEx(fgmask,cv2.MORPH_TOPHAT,kernel_keys)
...
if __name__ == "__main__":    
    ...
    createMidi(notes_per_frame,volumes_per_frame,25) #FPS of video
